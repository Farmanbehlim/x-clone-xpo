    ...
    const createPostMutation = useMutation({
        ...
        onSuccess: (newPost) => {
            ...
            queryClient.setQueryData(["AllUserPost"], (oldData: any) => {
                ...
                console.log(firstPage, 'olddata');
                const updatedFirstPage = {
                    ...firstPage,
                    posts: [newPost?.data?.post, ...firstPage?.posts]
                }
                return {
                    ...oldData,
            ...
            queryClient.setQueryData(["AllMainUserPost", userId], (oldData: any) => {
                ...
                if (!oldData) {
                    // Construct initial structure expected by useInfiniteQuery
                    return {
                        pageParams: [1], // or null/undefined if your API expects that
                        pages: [
                            {
                                posts: [newPostData],
                                pagination: {
